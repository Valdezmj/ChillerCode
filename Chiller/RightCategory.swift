...
class RightCategory : UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func loadPosters() {
        let photo1 = UIImage(named: "beta")
        let personOne = Post(name: "Location Name", body: "Beer!", title: "Offering free beer", image: "tracks", chill: false, burn: false, time: "0 minutes ago", comments: "100 comments", pics: "100+ pics", videos: "100+ videos")
        let personTwo = Post(name: "Location Name", body: "Beer!", title: "Offering free beer", image: "tracks", chill: false, burn: false, time: "0 minutes ago", comments: "100 comments", pics: "100+ pics", videos: "100+ videos")
        let personThree = Post(name: "Location Name", body: "Beer!", title: "Offering free beer", image: "tracks", chill: false, burn: false, time: "0 minutes ago", comments: "100 comments", pics: "100+ pics", videos: "100+ videos")
